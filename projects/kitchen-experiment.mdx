...
To gain a more robust understanding of the use case, we conducted contextual inquiries with 5 home cooks of varying skill levels to observe how they navigate digital recipes. While users are generally able to complete the tasks through workarounds, the operations were less than desirable.
