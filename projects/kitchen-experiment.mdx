...
Leveraging iOS TrueDepth Camera, we can accurately detect gesture distances and prevent unwanted triggers effectively.

To design around this sensor, I developed a technique to process depth sensor data, capturing and smoothing user movements using Swift. The resulted platform allowed quick testing of various gesture approaches.
