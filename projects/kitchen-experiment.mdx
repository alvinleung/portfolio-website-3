...
In early experiments, we explored the idea of creating an air gesture pointer system. Similar to a desktop pointer, the user will control a vitual pointer by gesturing in front of the device. However, the idea was quickly abandoned as we found that _using a pointer system is a rather intricate task that adds cognitive overhead_.
...
That lead us to experimenting with air gesture based “drag to scrub” interaction. It make sense if we think about translating the 2d haptic scroll experience to a 3d air-gesture space.
...
Yet, aside from unresolved rejection on enter/exit motion, it alos suffer from ergonomic issues. Users find it physically fatiguing to use
...
Who would have thought this deceptively simple solution is the best out of the three. It was particularly rewarding when we have the approval of our supervisor:
...
## Reflection: In praise of the barely working prototype

When prototyping, it's easy to fall into the trap of perfectionism. After all, you want your idea to have the best possible chance of success with users. Throughout our process, we kept pushing testing sessions back because we didn't feel "ready." But the truth is, we would never truly feel ready.

It wasn't until we set a hard deadline of "no prototype, no dinner" that we forced ourselves to test our design in situ. Surprisingly, the prototypes we thought were "not ready" turned out to be incredibly valuable for learning about the use case.
...
<LayoutMainContent grid="2/3" extraMargin>
  ...
  >
    <Caption
      label="9"
      text="One particularly wonderful moment came when we essentially hacked together a ChatGPT voice interaction client and open a YouTube tab next to it. Despite its rough form, this prototype provided us with invaluable behavioral insights into how our potential solution could function.
"
      overlay={false}
      topPadding
    />
...
## Reflection: Don’t overthink ideation — Ideas come when you start making things
...
<Caption
      label="10"
      text="The possibility of a circular gesture was enabled as we figured out the dynamic bounding box technique for detecting finger gesture motion around a point. But the circular gesture was ultimately not pursued as we weren’t able to find an elegant way to exit the gesture control."
      overlay={false}
      topPadding
    />
  </Video>
...
## Reflection: Formative qualitative testing and feedback don't have to be overly complex or rigorous to be valuable; they just need to make sense.

The ultimate goal is to expand your thinking in the problem space.
...
A fascinated dad trying to scrub video with head—slighlty less violant than pointing a knife at the prototype(yes, someone did try the interaction with a knife)
