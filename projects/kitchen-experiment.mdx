...
previewVideo: https://stream.mux.com/vCGTYkpLOGPTMWxfF2GV9kaemuouP3NVSKsORUoJm00Y/capped-1080p.mp4

scope: 8 weeks project (early 2023)
weight: 10
---
...
<LayoutMainContent grid="2/3" extraMargin>
  ...
  >
    <Caption
      ...
      text="By holding their hands in front of their device, users can toggle the play state."
      overlay={false}
      topPadding
    />
  </Video>
  ...
  >
    <Caption
      label="2"
      title="Hold & lean: scrub"
      text="After their hands enter the interaction zone, they can lean left or right to activate scrubbing backward or forward."
      overlay={false}
      topPadding
    />
  </Video>*/}
...
<LayoutMainContent>
  ...
  >
    <Caption
      ...
      text="When user hands are occupied, voice queries enable users to handle cooking tasks and look up recipes hands-free."
      overlay={false}
      topPadding
    />
  </Video>
