...
<LayoutFull extraMargin>
  <Video
    src="https://www.sfu.ca/~kkl64/videos/kitchen-experiment/assembly-top-down.mp4"
    canScrub={false}
  />
</LayoutFull>
...
<LayoutMainContent grid="2/3" extraMargin>
  <Video
    src="https://www.sfu.ca/~kkl64/videos/kitchen-experiment/getting-dirty.mp4"
    canScrub={false}
  />
</LayoutMainContent>
...
<LayoutMainContent grid="2/3" extraMargin>
  ...
  <Video
    src="https://www.sfu.ca/~kkl64/videos/kitchen-experiment/	knuckle-interaction_2.mp4"
    canScrub={false}
  >
    <Caption
      label="4"
