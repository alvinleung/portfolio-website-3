...
Here, we saw the opportunity to challenge the dominant touch paradigm of modern mobile devices—no buttons, scroll views, or scrubbers.
...
<List>
  <ListItem label="1">
    _Visual aids matter:_ Participants stressed the value of visual instructions. Videos and images help home cooks match their actions intuitively, making recipes more accessible.
...
Leveraging iOS TrueDepth Camera, we can accurately detect gesture distances and prevent unwanted triggers.
