...
previewVideo: https://stream.mux.com/iiKxesWVLz7VRy3WKhG7Z69e00sa5c2I9foZwygHhvN00/capped-1080p.mp4
...
<LayoutFull extraMargin>
  <Video
    src="https://stream.mux.com/KknyvMo5YqAXmZM0062Ts96Qs6uxVTaBo00zRtI81Pwuc/capped-1080p.mp4"
    canScrub={false}
  />
</LayoutFull>
...
Slimy raw meat, dusty flour, and a million other things in the kitchen make you think twice before touching your devices.
Surveying HCI literature, we found promising ideas like [on-skin gesture control](https://www.tandfonline.com/doi/full/10.1080/14606925.2022.2058444) but it requires custom hardware, while recipe apps on the market often neglect the during-cooking phase.

Here, we saw the opportunity to challenge the dominant touch paradigm of modern mobile devices.

## A touchless cooking companion

No taps, flicks, or swipes. Our reimagined cooking experience integrates air-gesture and voice-query capabilities, allowing the user to focus on creating delicious meals, mess-free.

<LayoutMainContent grid="2/3" extraMargin>
  <Video
    src="https://stream.mux.com/8saNWBcuShN9bqGp00Y7WFHorX3eCRIPD8Bhgx2VrGYA/capped-1080p.mp4"
    canScrub={true}
  >
    <Caption
      label="1"
      title="Hold: play and pause"
      text="Users can toggle the play state by holding their hands in front of their device."
      overlay={false}
      topPadding
    />
  </Video>
  <Video
    src="https://stream.mux.com/s0000cfxUymggwk3wkk6vWwGGhCAPdUntA00019nf00x01g78/capped-1080p.mp4"
    canScrub={true}
  >
    <Caption
      label="2"
      title="Hold & lean: scrub"
      text="Users can scrub through the video by tilting their hand to one side, similar to using arrow keys, after activating control mode."
      overlay={false}
      topPadding
    />
  </Video>
...
<LayoutMainContent>
  <Video
    src="https://stream.mux.com/EF00EC301iNUOJONgvImvciR1VmhghcMZp01Ns1yn00qQsc/capped-1080p.mp4"
    canScrub={true}
  >
    <Caption
      label="3"
      title="Voice query: hands-free recipe lookup"
...
<LayoutMainContent grid="2/3">
  <Image
    src="/project-assets/kitchen-experiment/voice-unit-image-2-sq.jpg"
    width={585 * 1.5}
    height={585 * 1.5}
  >
    <Caption
      label="4"
      title="Mentioned measurements"
      text='A common question during recipe lookup is "how much". Measurement is highlighted when voice answers mentioned an ingredient.'
      topPadding
      overlay={false}
    />
  </Image>
  <Image
    src="/project-assets/kitchen-experiment/voice-action-wide-image.jpg"
    width={877 * 1.5}
    height={585 * 1.5}
  >
    <Caption
...
To gain a more ps:robust understanding of digital recipes usage during cooking, we conducted contextual inquiries with 5 home cooks of varying skill levels.
...
<LayoutMainContent grid="2/3" extraMargin>
  <Video
    src="https://stream.mux.com/hstjmVOd5bZPOov01MVfkXvvLvFfzjv35U00pcNwVrnA4/capped-1080p.mp4"
    width={1920}
    height={1080}
    canScrub={true}
  >
  ...
  <Video
    src="https://stream.mux.com/SN57e7YlwE9Zf00z9NjKBWPK5tuFPy1f
OBHFK6018cZ6Y/capped-1080p.mp4"
    canScrub={true}
  >
    <Caption
      label="7"
...
Using the [research-through-design](https://www.interaction-design.org/literature/book/the-encyclopedia-of-human-computer-interaction-2nd-ed/research-through-design#:~:text=41.1.4%20Research%20through%20Design%3A%20Doing%20design%20as%20a%20part%20of%20doing%20research) methodology, designers develop understanding for the problem space through tangible prototypes.
...
<List>
  ...
  <ListItem label="2">
    _Appeal to the user's existing mental model_: for video
...
The circular motion solves the in-between-swipe motion. Yet, aside from unresolved rejection on enter/exit motion, it also suffer from ergonomic issues. Users find it physically fatiguing to use
