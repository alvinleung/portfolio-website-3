...
I developed a technique to process depth sensor data, capturing and smoothing user movements using Swift. This platform allowed quick testing of various gesture approaches.
