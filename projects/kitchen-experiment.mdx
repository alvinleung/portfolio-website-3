...
We were stuck, but then we remembered a user behaviour observed in the study: a participant dashed around a youtube video instruction just by holding down the arrow keys. This inspired us to pursue the idea of using “leaning” to capture user’s intent of video scrubbing.
...
<List>
  <ListItem label="1">
    ...
    spatial position—which demand less motor precision.
  </ListItem>
  <ListItem label="2">
    It provide continuous feedback with the subtle following motion that
...
<LayoutMainContent grid="2/3" extraMargin>
  ...
  >
    <Caption
      label="8"
      text="This voice + youtube prototype will forever remain in my prototype hall of fame."
      overlay={false}
      topPadding
    />
  </Image>
...
A fascinated dad trying to scrub video with head—slighlty less violant than pointing a knife at the prototype(yes, someone did try to interact with the prototype with a knife)
