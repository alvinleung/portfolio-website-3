...
Informed by the insights, we decided to take a multi-modal approach and established the following lines of investigation:
...
That lead us to experimenting with air gesture based “drag to scrub” interaction

Insert exploration images here
...
However, Users find it physically fatiguing to use this gesture for a prolonged period of time.
