...
To experiment with air gestures, I learned Swift and developed a novel technique to process depth sensor data, capturing and smoothing user movements. This created a platform that enabled rapid iteration on various gesture approaches.
