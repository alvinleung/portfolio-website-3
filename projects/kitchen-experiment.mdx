...
As fellow home cooks, we understand the frustration. Slimy raw meat, dusty flour, and a million other things in the kitchen make you think twice before touching your devices.

Here, we we see the opportunity to challenge the dominant touch paradigm of modern mobile devices. Without buttons, scroll views or scrubbers, is it even possible?

## A touchless cooking companion

Effortlessly navigate recipes without ever touching your device. Our reimagined cooking experience integrates air-gesture and voice-query capabilities, allowing you to focus on creating delicious meals, mess-free. No taps, flicks, or swipes—just seamless, intuitive interaction.
...
To gain a more robust understanding of digital recipes navigation during cooking, we conducted contextual inquiries with 5 home cooks of varying skill levels. While users managed to complete tasks with workarounds, the experience was suboptimal.
...
Through affinity diagramming, we uncovered these key insights:

<List>
  <ListItem label="1">
    _Pictures speak a thousand words_. Participants stressed the value of visual instructions. Videos and images help home cooks match their actions intuitively, making recipes more accessible.

  </ListItem>
  <ListItem label="2">
    _Keep design interventions minimal_ Distractions from recipe lookups can be mentally taxing. Lightweight solutions help users stay focused on cooking.

  </ListItem>
  <ListItem label="3">
    _Participants move around the kitchen_, Users move around the kitchen, often without direct sightlines to digital devices, emphasizing the need for accessible, hands-free solutions.
...
To faclitate the exploration, I developed a technique to process depth sensor data, capturing and smoothing user movements using Swift. This platform allowed quick testing of various gesture approaches.
...
<LayoutFull extraMargin>
  ...
  >
    <Caption
      ...
      wideSpacing
      text="
The motion graphic illustrates the signal processing pipeline, leveraging iOS depth sensors to accurately detect gesture distances and prevent unwanted triggers effectively."
      overlay={true}
      topPadding
    />
  </Video>
...
To bring focus on exploration, we have decided to tackle the more complex air-gesture scrubbing first.
...
While intuitive, the scrubbing system suffer a few drawbacks that makes it particularly tricky to move forward.
