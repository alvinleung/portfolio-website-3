...
<LayoutFull extraMargin>
  ...
  >
    <Caption
      label="8"
      wideSpacing
      text="THe motion demostrates the signal processing pipeline. Depth sensor on iOS devices enables the software to know how far away a gesture is performed. This capability is crucial for reliably preventing unwanted triggers."
      overlay={true}
      topPadding
    />
  </Video>
