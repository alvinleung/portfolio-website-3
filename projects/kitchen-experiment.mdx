...
<List>
  ...
  <ListItem label="3">
    ...
    a line of sight with the digital device, especially when they are using a
    tablet.
  </ListItem>
</List>
...
Originally designed for Face ID, the depth sensor front-facing camera reliably extracts air gesture distances. I learned Swift and created a technique to process sensor data, capturing and smoothing user movements. This enabled rapid iteration on various gesture approaches.
