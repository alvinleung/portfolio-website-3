...
description: Exhibiting daring speculations
...
<LayoutMainContent extraMargin>
  ...
  >
    <Caption
      label="5"
      text="Three initial interaction design approaches that emerge from precedent research and hands-on exploration."
    />
  </Video>
</LayoutMainContent>
