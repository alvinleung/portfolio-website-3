...
export const ParagraphBig = (children: any) => (
  <p className="col-start-1 sm:col-start-2 col-span-full md:col-start-2 md:col-span-3 mt-48 mb-32 text-3xl leading-[1.16em] xl:leading-[1.16em] -tracking-[.015em] font-normal lg:text-4xl xl:text-5xl">
    {children}
  </p>
);
